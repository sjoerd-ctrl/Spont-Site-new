      ...
      <section className="bg-[#FFFFFF] pb-16 px-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-[#F9FAFB] rounded-3xl p-8 md:p-10 flex flex-col sm:flex-row items-start gap-6">
            <div className="w-12 h-12 bg-[#4353FF]/10 rounded-2xl flex items-center justify-center shrink-0">
              <Code size={22} className="text-[#4353FF]" />
            </div>
            <div>
              ...
              <Link
                href="/contact"
                className="inline-flex items-center text-sm font-semibold text-[#4353FF] hover:underline"
              >
